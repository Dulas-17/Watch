  ...
  series: [
    {
      ...
      genres: ["Action", "Fantasy", "Anime","Shonen"], // Added genres
      episodes: [
  ...
  movies: [
    {
      ...
      genres: ["Animation", "Romance", "Fantasy", "Drama","Anime"], // Added genres
...

    {
      ...
      genres: ["Drama", "Family", "Adventure","Romance"], // Added genres
...

    {
      ...
      genres: ["Action", "Sci-Fi", "Adventure"], // Added genres
